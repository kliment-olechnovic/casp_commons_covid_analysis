...
legend(0, -9, legend=c("max. EMA-jury consensus score", "max. overall consensus score"), bty="n", xpd=TRUE, pt.cex=2, pch=c(22, 22), col=c("black", "black"), pt.bg=c("gray90", "gray40"))
dev.off();
EOF
} \
| sed "s/SCORENAME/${SCORENAME}/g" \
